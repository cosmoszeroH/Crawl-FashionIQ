...
dress_save_path = r'.\fashionIQ_dataset\images'
dress_url_path = r'.\url\asin2url.dress.txt'
dress_error_path = r'.\error\dress_error.txt'
get_images_by_category(dress_url_path, dress_save_path, dress_error_path)


shirt_save_path = r'.\fashionIQ_dataset\images'
shirt_url_path = r'.\url\asin2url.shirt.txt'
shirt_error_path = r'.\error\shirt_error.txt'
get_images_by_category(shirt_url_path, shirt_save_path, shirt_error_path)


toptee_save_path = r'.\fashionIQ_dataset\images'
toptee_url_path = r'.\url\asin2url.toptee.txt'
toptee_error_path = r'.\error\toptee_error.txt'
